...
subroutine mc_sweep
  use common
  implicit none
  integer(kind=4) :: i,j,k,m,charge,glob,totq,mu1,mu2,pm1
  integer(kind=4), dimension(2) :: site
  real(kind=8) :: eo1,eo2,eo3,eo4,en1,en2,en3,en4
  real(kind=8) :: u_tot,u_tot_run,increment
  real(kind=8) :: old_e, new_e, delta_e, g_thr
