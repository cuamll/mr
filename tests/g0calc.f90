program g0calc
  ...
  real*8 :: g_zero,g1sepx,g1sepy,g1sepz,kx,ky,kz,pi,a
      ...
      do ny=-(L(i)-1)/2,L(i)/2
        ...
        do nz=-(L(i)-1)/2,L(i)/2
          ...
          if ((nx.eq.0).and.(ny.eq.0).and.(nz.eq.0)) then
            ...
            g1sepx=g1sepx+cos(kx*a)/(3-cos(kx*a)-cos(ky*a)-cos(kz*a))
            g1sepy=g1sepy+cos(ky*a)/(3-cos(kx*a)-cos(ky*a)-cos(kz*a))
            g1sepz=g1sepz+cos(kz*a)/(3-cos(kx*a)-cos(ky*a)-cos(kz*a))
