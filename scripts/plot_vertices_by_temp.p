...
set ylabel '\Large $ \left< \bar{\mathbf{E}} \right> $'
...
plot FILE index 0 w lp ls 2 ps POINTSIZE title '\footnotesize 2 chg.', \
       '' index 1 w lp ls 3 ps POINTSIZE title '\footnotesize 4 chg.', \
