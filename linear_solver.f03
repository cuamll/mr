          ...
          do y=1,L
            do x=1,L
              ...
              if (v(x,y,z).ne.0) then ! non-zero charge at (x,y,z)
                ...
                sum_x = sum_x + charge * (+1)&
                      * (lgf(a,b,c,pos(x),y,z) - lgf(a,b,c,x,y,z))
                sum_y = sum_y + charge * (+1)&
                      * (lgf(a,b,c,x,pos(y),z) - lgf(a,b,c,x,y,z))
                sum_z = sum_z + charge * (+1)&
                      * (lgf(a,b,c,x,y,pos(z)) - lgf(a,b,c,x,y,z))
                  ...
                  do ky=-(L-1)/2,L/2
                    do kx=-(L-1)/2,L/2
                      ...
                      if ((kx.eq.0).and.(ky.eq.0).and.(kz.eq.0)) then
                        ...
                        lgf(a,b,c,x,y,z)=lgf(a,b,c,x,y,z)+&
                          (cos(fkx*p1)*cos(fky*q1)*cos(fkz*r1))&
